...
export function ComingSoon({ title, description, icon }: ComingSoonProps) {
  ...
  return (
    <div className="relative flex min-h-full flex-1 items-center justify-center overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        <h1
          className="glitch-text mb-2 text-4xl font-bold md:mb-6 md:text-6xl lg:text-8xl"
          data-text={title}
        >
          {title}
        </h1>

        <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-gray-300 md:text-xl lg:text-2xl">
          {description}
        </p>
